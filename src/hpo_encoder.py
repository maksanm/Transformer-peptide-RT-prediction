...
OUTPUT_DIR = f"models/hpo_encoder/{DATASET}/"
SEED = 42

# HPO settings
# Using 150 total trials: with 378 total configs (7×9×6) and ~14% invalid (45 configs where d_model % n_head != 0),
...
def main():
    ...
    study_name = f"peptide_rt_encoder_{DATASET}"
